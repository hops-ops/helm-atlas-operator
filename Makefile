...
PACKAGE ?= helm-atlas-operator
XRD_DIR := apis/atlasoperators
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/atlasoperators/standard.yaml
...
EXAMPLES := \
    examples/atlasoperators/minimal.yaml:: \
    examples/atlasoperators/standard.yaml::
...
render\:%:
	@example="examples/atlasoperators/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
